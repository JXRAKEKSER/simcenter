...
from app.services.parsec.parsec_service import get_events, delete_events
...
def schedule_tasks():
    ...
    schedule.every().day.at("23:55").do(delete_events)

    schedule.every(10).seconds.do(get_events)
