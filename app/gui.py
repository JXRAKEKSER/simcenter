...
class MainWindow(QWidget):
    ...
    def handle_language_change(self):
        ...
        self.title = self.get_translation('About AKT')
        self.about_button.setToolTip(self.get_translation('About AKT'))
    ...
    def set_about(self, icon, global_layout):
        def show_about():
            message = u" <center> "
            message += self.get_translation('All credit reserved to the author of AKT version ') + VERSION + u" "
            ...
            title = self.get_translation('About AKT')
