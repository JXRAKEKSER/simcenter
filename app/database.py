...
class Access(db.Model, Mixin):
    ...
    TIME_BEGIN = db.Column(db.String(45))
    TIME_END = db.Column(db.String(45))
    specialization_id = db.Column(db.Integer, db.ForeignKey("specialization.id", ondelete='cascade'), nullable=True)
...
class Stud_access(db.Model, Mixin):
    ...
    time_end = db.Column(db.String(200), nullable=True)
    specialization = db.Column(db.String(100), nullable=True)
    date = db.Column(db.String(50))
    flow = db.Column(db.Integer, nullable=True)

class Logs(db.Model, Mixin):
    __tablename__ = "logs"
    idlogs = db.Column(db.Integer, autoincrement=True, primary_key=True)
    source = db.Column(db.String(100), nullable=True)
    name_subject = db.Column(db.String(100), nullable=True)
    event = db.Column(db.String(100), nullable=True)
    date = db.Column(db.String(100), nullable=True)
    time = db.Column(db.Time(200), nullable=True)
    id_subject = db.Column(db.String(45), nullable=True)

class History(db.Model, Mixin):
    __tablename__ = "history"
    id = db.Column(db.Integer, autoincrement=True, primary_key=True)
    name_student = db.Column(db.String(200), nullable=True)
    event = db.Column(db.String(150), nullable=True)
    num_room = db.Column(db.String(45), nullable=True)
    date_his = db.Column(db.String(100), nullable=True)
    time_his = db.Column(db.String(100), nullable=True)
...
class Station(db.Model, Mixin):
    ...
    id = db.Column(db.Integer, primary_key=True)
    spec_id = db.Column(db.String(45))
    name = db.Column(db.String(200))
    room = db.Column(db.String(45))
    briefing = db.Column(db.String(1000))


class Specialization(db.Model, Mixin):
...
class Stud_list(db.Model, Mixin):
    __tablename__ = "student_list"
    id = db.Column(db.Integer, primary_key=True)
    nomer = db.Column(db.String(45))
    name = db.Column(db.String(200))
    kabinet = db.Column(db.String(45))
    level = db.Column(db.Integer)
    time = db.Column(db.String(45))
    image = db.Column(db.String(200))
    ident = db.Column(db.String(45))

class Tablo(db.Model, Mixin):
    __tablename__ = "tablo"
    id = db.Column(db.Integer, primary_key=True)
    nomer = db.Column(db.String(45))
    name = db.Column(db.String(200))
...
class Monitor(db.Model, Mixin):
    __tablename__ = "monitor"
    id = db.Column(db.Integer, primary_key=True)
    station_id = db.Column(db.Integer, db.ForeignKey("station.id", ondelete='cascade'), nullable=True)
    text = db.Column(db.Text)
    active = db.Column(db.Boolean)


class Worktime(db.Model, Mixin):
...
class Display_store(db.Model, Mixin):
    ...
    def __init__(self, id=0, title="Queue Management",
